...
namespace FileEnumeration
{
    ...
    public delegate void EnumerationCompleteEventHandler(object sender, EnumerationCompleteEventArgs e);
    ...
    public class DirFileEnumeration
    {
        ...
        public event EnumerationCompleteEventHandler EnumerationComplete;
        ...
        protected virtual void OnEnumerationComplete(EnumerationCompleteEventArgs e)
        {
            if(EnumerationComplete != null)
                EnumerationComplete(this, e);
        }
        ...
        public void EnumerateFiles(string rootDirectory)
        {
            ...
            OnEnumerationComplete(new EnumerationCompleteEventArgs());
